    ...
    <section id="viagens" className="py-20 md:py-28 bg-white">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtrados.map((d) => {
            const msg = `Olá, Lisa! Tenho interesse em viajar para ${d.nome} (${d.estado}). Quando tem a próxima saída?`;
        ...
        <div className="text-center mt-14">
          ...
          <a
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Olá, Lisa! Gostaria de saber sobre outros destinos da Amo Viajar.")}`}
            target="_blank"
            rel="noopener noreferrer"
